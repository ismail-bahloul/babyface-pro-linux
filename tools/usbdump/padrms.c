// Confirm bit 5 = AN2 PAD with long RMS windows on the noise floor.
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
#include <errno.h>
...
int main(void) {
    ...
    printf("KEEP QUIET. Long RMS windows, bit 5 = 0x20.\n");
    printf("  base 0x0E #1: RMS=%9.1f\n", rms(4000));
    ctl(0x17, 0x000E | 0x20, 0x003F); ctl(0x21, 0x0000, 0x0000);
    printf("  0x2E (bit5):  RMS=%9.1f\n", rms(4000));
    ctl(0x17, 0x000E, 0x003F); ctl(0x21, 0x0000, 0x0000);
    printf("  base 0x0E #2: RMS=%9.1f\n", rms(4000));
    ctl(0x17, 0x000E | 0x20, 0x003F); ctl(0x21, 0x0000, 0x0000);
    printf("  0x2E again:   RMS=%9.1f\n", rms(4000));
    ctl(0x17, 0x000E, 0x003F); ctl(0x21, 0x0000, 0x0000);
