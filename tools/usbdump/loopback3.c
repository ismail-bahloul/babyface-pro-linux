// loopback3.c — map the loopback channel semantics: which single
// channel engages the AN1/2 loopback, and which single channel clears
// it. ON = 0x15 0x0001 wIdx=ch, OFF = 0x15 0x0000 wIdx=ch. The IN ch0
// level tells us if the tone feedback is live.
#define _GNU_SOURCE
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
int main(void) {
    ...
    init_session();
    printf(">>> loopback map — IN ch0 level after each write <<<\n");
    printf("  baseline                       : %6.1f dBFS\n", level_ms(1200));
    ctl(0x15, 0x0001, 0);
    printf("  ON  ch 0 only                  : %6.1f dBFS\n", level_ms(1200));
    ctl(0x15, 0x0000, 0); ctl(0x15, 0x0000, 1); ctl(0x15, 0x0000, 2); ctl(0x15, 0x0000, 3);
    printf("  clear ch0-3                    : %6.1f dBFS\n", level_ms(1200));
    ctl(0x15, 0x0001, 1);
    printf("  ON  ch 1 only                  : %6.1f dBFS\n", level_ms(1200));
    ctl(0x15, 0x0000, 0); ctl(0x15, 0x0000, 1); ctl(0x15, 0x0000, 2); ctl(0x15, 0x0000, 3);
    printf("  clear ch0-3                    : %6.1f dBFS\n", level_ms(1200));
    ctl(0x15, 0x0001, 2);
    printf("  ON  ch 2 only                  : %6.1f dBFS\n", level_ms(1200));
    ctl(0x15, 0x0000, 0); ctl(0x15, 0x0000, 1); ctl(0x15, 0x0000, 2); ctl(0x15, 0x0000, 3);
    printf("  clear ch0-3                    : %6.1f dBFS\n", level_ms(1200));
    ctl(0x15, 0x0001, 3);
    printf("  ON  ch 3 only                  : %6.1f dBFS\n", level_ms(1200));
    ctl(0x15, 0x0000, 0); ctl(0x15, 0x0000, 1); ctl(0x15, 0x0000, 2); ctl(0x15, 0x0000, 3);
    printf("  clear ch0-3                    : %6.1f dBFS\n", level_ms(1200));
    /* which single channel clears it? */
    ctl(0x15, 0x0001, 0); ctl(0x15, 0x0001, 1);
    printf("  ON ch0+1                       : %6.1f dBFS\n", level_ms(1200));
    ctl(0x15, 0x0000, 0);
    printf("  OFF ch 0 only                  : %6.1f dBFS\n", level_ms(1200));
    ctl(0x15, 0x0000, 1);
    printf("  OFF ch 1 only                  : %6.1f dBFS\n", level_ms(1200));
    ctl(0x15, 0x0000, 2);
    printf("  OFF ch 2 only                  : %6.1f dBFS\n", level_ms(1200));
    ctl(0x15, 0x0000, 3);
    printf("  OFF ch 3 only                  : %6.1f dBFS\n", level_ms(1200));
